...
app = Flask(__name__)
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'allison-beauty-secret-2026')
...
PRODUCTS = {
    'glow_serum': {
        ...
        'rating': 4.8, 'reviews': 234, 'popular': True, 'badge': 'Best Seller', 'stock': 45
    },
    'hydrating_cream': {
        'id': 'hydrating_cream',
        ...
        'rating': 4.6, 'reviews': 189, 'popular': False, 'badge': 'New', 'stock': 60
    },
    'retinol_night': {
        'id': 'retinol_night',
        ...
        'rating': 4.9, 'reviews': 312, 'popular': True, 'badge': "Editor's Choice", 'stock': 30
    },
    'sunscreen_spf': {
        'id': 'sunscreen_spf',
        ...
        'rating': 4.5, 'reviews': 156, 'popular': False, 'badge': '', 'stock': 80
    },
    'face_mask': {
        'id': 'face_mask',
        ...
        'rating': 4.4, 'reviews': 98, 'popular': False, 'badge': '', 'stock': 55
    },
    'eye_cream': {
        'id': 'eye_cream',
        ...
        'rating': 4.7, 'reviews': 145, 'popular': True, 'badge': 'Trending', 'stock': 40
    },
    'cleansing_balm': {
        'id': 'cleansing_balm',
        'name': 'Cleansing Balm',
        ...
        'rating': 4.3, 'reviews': 78, 'popular': False, 'badge': '', 'stock': 70
    },
    'toner': {
        'id': 'toner',
        'name': 'Hydrating Facial Toner',
        'price': 18.99,
        'image': 'https://images.pexels.com/photos/6621461/pexels-photo-6621461.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop',
        'category': 'Toners',
        ...
        'rating': 4.2, 'reviews': 67, 'popular': False, 'badge': '', 'stock': 90
    },
    'niacinamide': {
        'id': 'niacinamide',
        ...
        'rating': 4.7, 'reviews': 203, 'popular': True, 'badge': 'Best Seller', 'stock': 50
    },
    'peptide_cream': {
        'id': 'peptide_cream',
        'name': 'Peptide Firming Cream',
        'price': 38.99,
        'image': 'https://images.pexels.com/photos/3762875/pexels-photo-3762875.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop',
        'category': 'Moisturizers',
        ...
        'rating': 4.8, 'reviews': 167, 'popular': False, 'badge': 'New', 'stock': 35
    }
}

BUNDLES = {
    'skincare_starter': {
        'id': 'skincare_starter', 'name': 'Skincare Starter Bundle', 'price': 49.99,
        'products': ['cleansing_balm', 'toner', 'hydrating_cream'], 'savings': 20.98, 'popular': True,
        'image': 'https://images.pexels.com/photos/4041391/pexels-photo-4041391.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop'
    },
    'glow_bundle': {
        'id': 'glow_bundle', 'name': 'Glow Getter Bundle', 'price': 69.99,
        'products': ['glow_serum', 'hydrating_cream', 'sunscreen_spf'], 'savings': 28.98, 'popular': True,
        'image': 'https://images.pexels.com/photos/3762879/pexels-photo-3762879.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop'
    },
    'night_renewal': {
        'id': 'night_renewal', 'name': 'Night Renewal Bundle', 'price': 89.99,
        'products': ['cleansing_balm', 'retinol_night', 'eye_cream', 'hydrating_cream'], 'savings': 41.97, 'popular': False,
        'image': 'https://images.pexels.com/photos/4465124/pexels-photo-4465124.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop'
    },
    'complete_routine': {
        'id': 'complete_routine', 'name': 'Complete Skincare Routine', 'price': 129.99,
        'products': ['cleansing_balm', 'toner', 'glow_serum', 'hydrating_cream', 'sunscreen_spf', 'eye_cream'], 'savings': 63.94, 'popular': True,
        'image': 'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop'
    }
}
...
def index():
    ...
    return render_template('shop.html',
        ...
        best_sellers=best_sellers or list(PRODUCTS.values())[:4],
        new_arrivals=new_arrivals or list(PRODUCTS.values())[2:6],
        trending=trending or list(PRODUCTS.values())[4:8],
...
def cart():
    ...
    for item_id in cart_items:
        if item_id in PRODUCTS:
            p = PRODUCTS[item_id]
            cart_data.append({'id': item_id, 'name': p['name'], 'price': p['price'], 'image': p['image'], 'type': 'product'})
            total += p['price']
        elif item_id in BUNDLES:
            b = BUNDLES[item_id]
            cart_data.append({'id': item_id, 'name': b['name'], 'price': b['price'], 'image': b['image'], 'type': 'bundle', 'products': b['products']})
            total += b['price']
...
def checkout():
    ...
    for item_id in cart_items:
        if item_id in PRODUCTS:
            p = PRODUCTS[item_id]
            cart_data.append({'id': item_id, 'name': p['name'], 'price': p['price'], 'image': p['image']})
            total += p['price']
        elif item_id in BUNDLES:
            b = BUNDLES[item_id]
            cart_data.append({'id': item_id, 'name': b['name'], 'price': b['price'], 'image': b['image']})
            total += b['price']
